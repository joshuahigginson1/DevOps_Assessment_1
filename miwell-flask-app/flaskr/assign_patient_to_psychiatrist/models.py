...
from flaskr.register.models import Patient as PatientTable, Psychiatrist as PsychiatristTable
...
class PatientPsychiatristAssign(db.Model):  # Creates the schema for a 'trans-table' within our database.
    ...
    patient_username = db.Column(db.String(50), db.ForeignKey(PatientTable.username),primary_key=True),
    psychiatrist_bacp_number = db.Column(db.String(20), db.ForeignKey(PsychiatristTable.bacp_number))
