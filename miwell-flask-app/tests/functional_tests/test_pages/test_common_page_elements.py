...
def compare_and_evaluate_relative_urls(test_outcome, endpoint_bp):
    ...
    if full_endpoint_url == test_outcome:
        return True
    else:
        return False
...
class TestCommonPageElements(LiveServerTestCase):
    ...
    def test_page_title(self):
        get_page_title = CommonPageObject.get_page_title(self)
    ...
    def test_page_footer(self):
        ...
        self.assertEqual(get_page_footer['text'], self.footer_assertion)


class TestMainNavBar(LiveServerTestCase):

    def test_home_button_label(self):
        button_label_assertion = "Home"

        get_home_button = MainNavBar.get_home_button(self)['button label']
    ...
    def test_home_button_click(self):
        get_home_button = MainNavBar.get_home_button(self)['button element']

        get_home_button.click()  # Simulates a button click
        ...
        self.assertTrue(compare_and_evaluate_relative_urls(page_url, 'main_bp.homepage'))

    def test_about_button_label(self):
    ...
    def test_about_button_click(self):
        get_about_button = MainNavBar.get_about_button(self)['button element']

        get_about_button.click()  # Simulates a button click
...
class TestPatientNavBar(LiveServerTestCase):
    ...
    def test_patient_dashboard_button_click(self):
        get_patient_dashboard_button = PatientNavBar.get_dashboard_button(self)['button element']
    ...
    def test_patient_progress_button_click(self):
        get_patient_progress_button = PatientNavBar.get_patient_progress_button(self)['button element']
    ...
    def test_patient_tools_button_click(self):
        get_patient_tools_button = PatientNavBar.get_patient_tools_button(self)['button element']
    ...
    def test_patient_logout_button_click(self):
        get_patient_logout_button = PatientNavBar.get_logout_button(self)['button element']

        get_patient_logout_button.click()  # Simulates a button click
    ...
    def test_patient_settings_button_click(self):
        get_patient_settings_button = PatientNavBar.get_acc_settings_button(self)['button element']

        get_patient_settings_button.click()  # Simulates a button click
    ...
    class TestPsychiatristNavBar(LiveServerTestCase):
        ...
        def test_psychiatrist_dashboard_button_label(self):
            ...
            print_assertion_to_console('psychiatrist dashboard button', get_psychiatrist_dashboard_button, button_label_assertion)
        ...
        def test_psychiatrist_dashboard_button_click(self):
            get_psychiatrist_dashboard_button = PsychiatristNavBar.get_dashboard_button(self)['button element']

            get_psychiatrist_dashboard_button.click()  # Simulates a button click
        ...
        def test_my_patients_button_click(self):
            get_my_patients_button = PsychiatristNavBar.get_my_patients_button(self)['button element']
        ...
        def test_psychiatrist_tools_button_click(self):
            get_psychiatrist_tools_button = PatientNavBar.get_psychiatrist_tools_button(self)['button element']
        ...
        def test_psychiatrist_logout_button_click(self):
            get_psychiatrist_logout_button = PsychiatristNavBar.get_logout_button(self)['button element']

            get_psychiatrist_logout_button.click()  # Simulates a button click
        ...
        def test_psychiatrist_settings_button_click(self):
            get_psychiatrist_settings_button = PsychiatristNavBar.get_acc_settings_button(self)['button element']

            get_psychiatrist_settings_button.click()  # Simulates a button click
